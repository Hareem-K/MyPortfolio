      ...
      <div className='cards__container'>
        <div className='cards__wrapper'>
            <ul className='cards__items'>
                ...
                text="A full-stack spa and laser treatment website built with React, TypeScript, and Tailwind CSS. It features a fully functional booking system where clients can view their appointment history and upcoming treatments, while the business can easily manage bookings and share important updates. The site includes a contact page with integrated messaging, a detailed services catalog with thorough descriptions and aftercare information, and a polished, professional UI designed for a real-world business."
                ...
                <ProjectCardItem
                images={[
                  "images/callmentor-1.png",
                  "images/callmentor-2.png",
                  "images/callmentor-3.png",
                ]}
                text="Callmentor Online Community is a C2C (community-to-community) platform that connects students, mentors, and employers in a single online hub. The application features a community forum for discussions and knowledge sharing, a job board where employers can post opportunities, and mentor integration so students can receive guidance throughout the application process. Administrators are included to review reports and maintain safety across the platform.  

The system was developed using React.js, CSS, and Bootstrap for the frontend, with PostgreSQL and Nest.js powering the backend. Features include user authentication, community creation, post interactions (likes, comments, reports), job posting and filtering, and role-based access for different types of users. This project emphasized full-stack development, team collaboration, and real-world scalability considerations."
                label='Callmentor Online Community | Capstone Project'
                openInNewTab={true}
                />
            </ul>
            <ul className='cards__items'>
          ...
          <ul className='cards__items'>
                <ProjectCardItem
                images={[
                  "images/PlotPonder.png",
                  "images/plotponder-1.png",
                  "images/plotponder-2.png",
                  "images/plotponder-3.png",
                  "images/plotponder-4.png",
                  "images/plotponder-5.png",
                ]}
