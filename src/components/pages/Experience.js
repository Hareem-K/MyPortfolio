    ...
    return (
        <>
            ...
            <div className='work'>
                ...
                <div className="text-container">
                    <div className="experience-item">
                        <h2 className="role-title">Operations Manager & Online Marketer | Prep 101, University of Calgary <span className="date">Aug 2022 – Current</span></h2>
                        <ul className="circle-list">
                            ...
                            <li>Supervise Operations Staff with student sign-ins to ensure prep sessions go smoothly by confirming adequate materials, assisting students with finding session locations, and answering any questions that arise during each session.</li>
            ...
            <div className='courses'>
                ...
                <p style={{ marginLeft: '20px'}}>Click on a semester to view my completed software courses</p>
